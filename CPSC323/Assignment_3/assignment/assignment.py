...
# use python 3.6 at least to run in pyCharm

# python3 assignment.py
# enter input file name as Test1.txt
# enter output display file name any
...
filename = input('Enter a Input fileName (e.g. Test1.txt): ')
...
filename = input('Enter a Output fileName (Choose any name, e.g. output.txt): ')
try:
